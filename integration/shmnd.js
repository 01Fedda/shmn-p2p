...
var _ = shmn-lib.deps._;
var Random = shmn-lib.crypto.Random;
var BN = shmn-lib.crypto.BN;
var BufferUtil = shmn-lib.util.buffer;
var p2p = require('..');
var Peer = p2p.Peer;
var Pool = p2p.Pool;
...
var Block = shmn-lib.Block;
var Transaction = shmn-lib.Transaction;
...
// These tests require a running shmnd instance
describe('Integration with ' + network.name + ' shmnd', function() {
